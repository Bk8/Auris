...
/**
* @brief Sums two given float arrays
* @param result The result array
* @param a The 1st array
* @param b The 2nd array
* @param len The length of the arrays
*/
void Sum(float* FFTCONVOLVER_RESTRICT result,
         const float* FFTCONVOLVER_RESTRICT a,
         const float* FFTCONVOLVER_RESTRICT b,
         size_t len);
...
*/
void ComplexMultiplyAccumulate(float* FFTCONVOLVER_RESTRICT re, 
                               float* FFTCONVOLVER_RESTRICT im,
                               const float* FFTCONVOLVER_RESTRICT reA,
                               const float* FFTCONVOLVER_RESTRICT imA,
                               const float* FFTCONVOLVER_RESTRICT reB,
                               const float* FFTCONVOLVER_RESTRICT imB,
                               const size_t len);
